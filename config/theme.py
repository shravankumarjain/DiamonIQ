...
SERIES_COLORS = [
    P["navy"], P["red"], P["gold"], P["green"],
    "#6A1B9A", "#00838F", "#E65100", "#5D4037",
]
...
def register_theme() -> None:
    ...
    template.layout = go.Layout(
        ...
        xaxis=dict(
            ...
            linecolor=P["grid"], tickfont=dict(size=12),
        ),
        yaxis=dict(
            gridcolor=P["grid"], zerolinecolor=P["grid"],
            linecolor=P["grid"], tickfont=dict(size=12),
        ...
        legend=dict(
            bgcolor="rgba(255,255,255,0.9)", bordercolor=P["grid"],
            borderwidth=1, font=dict(size=12),
        ),
        hoverlabel=dict(
            bgcolor="white", bordercolor=P["grid"],
